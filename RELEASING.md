# Releasing the Codex CLI harness

This repository publishes the public `tinyhat/harnesses/codex-cli` payload. It
versions independently from every other Tinyhat repository.
...
gh release create "$TAG" \
  --repo tinyloophub/tinyhat--harnesses--codex-cli \
  --title "$TAG" \
  --latest \
  --verify-tag \
